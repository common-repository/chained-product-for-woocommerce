	...
	foreach ( $selected_product as $current_products_id => $product_detail_array ) {
		...
		<tr class="woocommerce-table__line-item order_item">
			...
			<td class="woocommerce-table__product-name product-name">
				<a href="<?php echo esc_url( $current_products_obj->get_permalink() ); ?>  "><?php echo esc_attr( $current_products_obj->get_name() ); ?>  </a> 
				<strong class="product-quantity"><?php echo esc_attr( ' x ' . $selected_qty ); ?>  </strong>	
			</td>
